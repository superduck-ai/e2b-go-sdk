...
type FilesystemListOpts = rootfs.FilesystemListOpts
type WatchOpts = rootfs.WatchOpts
type WriteEntry = rootfs.WriteEntry
...
type GitResetOpts = rootgit.GitResetOpts
type GitRestoreOpts = rootgit.GitRestoreOpts
type GitResetMode = rootgit.GitResetMode
