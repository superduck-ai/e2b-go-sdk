	...
	cases := []struct {
	...
	}{
		{
			...
			mustHave: []string{
				...
				"type SandboxNetworkSelectorFunc func",
				...
				"type VolumeReadOpts =",
				"type VolumeListOpts =",
				"type VolumeConnectionOpts =",
				"type VolumeConnectionConfig =",
				"func CreateVolume(",
				"func ConnectVolume(",
				"func GetVolumeInfo(",
				"func ListVolumes(",
		...
		},
		{
			...
			mustMiss: []string{
				"func (c *Commands) RunForeground(",
				"func (c *Commands) RunBackground(",
				"func (c *Commands) RunWithMode(",
			},
		},
		{
			name: "filesystem",
		...
		},
		{
			...
			mustMiss: []string{
				"func (f *Filesystem) ReadBytes(",
				"func (f *Filesystem) ReadStream(",
				"func (f *Filesystem) ReadText(",
				"func (f *Filesystem) ReadWithFormat(",
			},
		},
		{
			name: "volume-type",
			...
			mustMiss: []string{
				...
				"func (v *Volume) ReadFileBytes(",
				"func (v *Volume) ReadFileStream(",
				"func (v *Volume) ReadFileText(",
				"func (v *Volume) ReadFileWithFormat(",
			},
		},
		{
			name: "git",
